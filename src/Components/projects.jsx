                            ...
                            <div className="row">
                                <div className="col-12 d-flex justify-content-center flex-column p-xl-5 px-4 py-md-2 py-4 my-2">
                                    ...
                                    <div className="d-flex justify-content-center mt-3" style={{ gap: '8px' }}>
                                        <a className="py-2 px-3 h5 rounded-pill text-decoration-none cursor_pointer project_btn_code_live_demo d-flex align-items-center" style={{ gap: '8px' }} href="https://github.com/balajik27/payment-service-monolithic" target="_blank">Code <img src="./assests/img/svg/github_color.svg" className="rounded-circle" height="20px" width="20px" alt="" /></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="projectBox">
                            <div className="row d-flex" >
                                ...
                                <div className="col-xl-7 col-lg-7 col-md-7 col-12 order-xl-1 order-lg-1 order-2 d-flex justify-content-center flex-column p-xl-5 px-4 py-md-2 py-4 py-2 my-2">
                                    <h2 className="text-center">MULTIVERSE - Business Clone Website</h2>
